...
//$this->print_array($this->pld_settings);
?>
<div class="wrap pld-wrap">
    ...
    <div class="pld-settings-section-wrap">
        ...
        <div class="pld-field-wrap pld-settings-action">
            <label></label>
            <div class="pld-field">
                <input type="button" class="pld-settings-save-trigger button-primary" value="<?php _e( 'Save settings', PLD_TD ); ?>"/>
                <input type="button" class="pld-settings-restore-trigger button-primary" value="<?php _e( 'Restore settings', PLD_TD ); ?>"/>
            </div>
        </div>
    </div>
